...
namespace gpopt
{
	...
	class CKeyCollection : public CRefCount
	{
		...
		public:
			...
			CKeyCollection(IMemoryPool *memory_pool, DrgPcr *pdrgpcr);
			...
			BOOL FKey(IMemoryPool *memory_pool, const DrgPcr *pdrgpcr) const;
			
			// trim off non-key columns
			DrgPcr *PdrgpcrTrim(IMemoryPool *memory_pool, const DrgPcr *pdrgpcr) const;
