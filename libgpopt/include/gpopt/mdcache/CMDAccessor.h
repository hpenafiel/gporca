...
namespace gpopt
{
	...
	class CMDAccessor
	{
		...
		private:
			...
			CHistogram *Phist(IMemoryPool *memory_pool, IMDId *mdid_type, const IMDColStats *pmdcolstats);
		...
		public:
			...
			CMDAccessor(IMemoryPool *memory_pool, MDCache *pcache, const DrgPsysid *pdrgpsysid, const DrgPmdp *pdrgpmdp);
