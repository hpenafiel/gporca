...
namespace gpopt
{
	...
	class CPartConstraint : public CRefCount
	{
		...
		public:
			...
			// ctors
			CPartConstraint(IMemoryPool *memory_pool, HMUlCnstr *phmulcnstr, CBitSet *pbsDefaultParts, BOOL fUnbounded, DrgDrgPcr *pdrgpdrgpcr);
			CPartConstraint(IMemoryPool *memory_pool, CConstraint *pcnstr, BOOL fDefaultPartition, BOOL fUnbounded);
			...
			CPartConstraint *PpartcnstrCopyWithRemappedColumns(IMemoryPool *memory_pool, HMUlCr *phmulcr, BOOL fMustExist);
