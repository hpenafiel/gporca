...
namespace gpopt
{
	...
	class CPredicateUtils
	{
		...
		public:
			...
			static
			BOOL FDisjunctionOnColumn(IMemoryPool *memory_pool, CExpression *pexpr, CColRef *pcr, CColRefSet *pcrsAllowedRefs);
			...
			static
			void SeparateOuterRefs(IMemoryPool *memory_pool, CExpression *pexprScalar, CColRefSet *pcrsOuter, CExpression **ppexprLocal, CExpression **ppexprOuterRef);
