			...
			void CreateCorrelatedApply(IMemoryPool *memory_pool, CExpression *pexprApply, CXformResult *pxfres)
            {
                ...
                switch (eopid)
                {
                    case COperator::EopLogicalInnerApply:
                        pexprResult = CUtils::PexprLogicalApply<CLogicalInnerCorrelatedApply>(memory_pool, pexprOuter, pexprInner, pdrgpcr, eopidSubq, pexprScalar);
                        break;

                    case COperator::EopLogicalLeftOuterApply:
                        pexprResult = CUtils::PexprLogicalApply<CLogicalLeftOuterCorrelatedApply>(memory_pool, pexprOuter, pexprInner, pdrgpcr, eopidSubq, pexprScalar);
                        break;

                    case COperator::EopLogicalLeftSemiApply:
                        pexprResult = CUtils::PexprLogicalApply<CLogicalLeftSemiCorrelatedApply>(memory_pool, pexprOuter, pexprInner, pdrgpcr, eopidSubq, pexprScalar);
                        break;

                    case COperator::EopLogicalLeftSemiApplyIn:
                        pexprResult = CUtils::PexprLogicalCorrelatedQuantifiedApply<CLogicalLeftSemiCorrelatedApplyIn>(memory_pool, pexprOuter, pexprInner, pdrgpcr, eopidSubq, pexprScalar);
                        break;

                    case COperator::EopLogicalLeftAntiSemiApply:
                        pexprResult = CUtils::PexprLogicalApply<CLogicalLeftAntiSemiCorrelatedApply>(memory_pool, pexprOuter, pexprInner, pdrgpcr, eopidSubq, pexprScalar);
                        break;
