	...
	)
{
	...
	{
		return CConstraintInterval::PciUnbounded(memory_pool, pcr, true /*fIncludesNull*/);
	}
...
CConstraintDisjunction::PcnstrRemapForColumn
	...
	const
{
	return PcnstrConjDisjRemapForColumn(memory_pool, pcr, m_pdrgpcnstr, false /*fConj*/);
}
