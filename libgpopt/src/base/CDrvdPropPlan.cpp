	...
	)
{
	...
	if (NULL != pdpplan)
	{
		...
		m_pos = pdpplan->Pos()->PosCopyWithRemappedColumns(memory_pool, phmulcr, true /*fMustExist*/);
		m_pds = pdpplan->Pds()->PdsCopyWithRemappedColumns(memory_pool, phmulcr, true /*fMustExist*/);
