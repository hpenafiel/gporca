	...
	)
{
	...
	CColRefSet *pcrsReqd = PcrsChildReqd(memory_pool, exprhdl, pcrs, ulChildIndex, 2 /*ulScalarIndex*/);
	pcrs->Release();
	...
	)
{
	...
	return PppsRequiredJoinChild(memory_pool, exprhdl, pppsRequired, ulChildIndex, pdrgpdpCtxt, true);
}
