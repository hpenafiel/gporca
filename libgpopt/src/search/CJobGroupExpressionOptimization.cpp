	...
	)
{
	...
	m_pdrgpstatCurrentCtxt = GPOS_NEW(psc->GetGlobalMemoryPool()) DrgPstat(psc->GetGlobalMemoryPool());
	...
	)
{
	...
	DrgPstat *pdrgpstatCtxt = GPOS_NEW(psc->GetGlobalMemoryPool()) DrgPstat(psc->GetGlobalMemoryPool());
