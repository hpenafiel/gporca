...
CMDTypeBoolGPDB::Pdatum
	...
	const
{
	CDXLDatumBool *pdxldatum = CDXLDatumBool::Cast(const_cast<CDXLDatum*>(pdxlop->Pdxldatum()));
...
CMDTypeBoolGPDB::Pdatum
	...
	const
{
	CDXLDatumBool *pdxldatumbool = CDXLDatumBool::Cast(const_cast<CDXLDatum *>(pdxldatum));
